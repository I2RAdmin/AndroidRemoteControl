...
public class ResponsePacket {
	 ...
	 *            about
	 * @param connection
	 *            - the connection to send the notification over
	...
	public static synchronized boolean sendNotification(int taskID,
		...
		return sendNotification(taskID, Character.toString(notification),
				connection);
	}
	

	/**
	 * See {@link #sendNotification(int, String, String, RemoteConnection)} for
	 * details on this method.
	 */
	public static synchronized boolean sendNotification(int taskID,
			char notification, String message, RemoteConnection connection) {
		return sendNotification(taskID, Character.toString(notification),
				message, connection);
	}
	...
	public static synchronized boolean sendNotification(int taskID,
		...
		return sendNotification(taskID, notification,
				Constants.Args.ARG_STRING_NONE, connection);
	}
	 ...
	 *            about
	 * @param extraData
	 *            - any extra data to further inform the controller about the
	 ...
	 */
	public static synchronized boolean sendNotification(int taskID,
			String notification, String message, RemoteConnection connection) {
	 ...
	 */
	public static synchronized boolean sendResponse(ResponsePacket packet,
			RemoteConnection connection) {
		byte[] result = null;
		if (packet != null && packet.isValid() && connection != null
			...
			if (result != null) {
				...
				Log.e(TAG,
						"could not send response because encodedPacket returned null");
			}
		} else {
